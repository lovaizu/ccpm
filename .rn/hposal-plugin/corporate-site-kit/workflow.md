...
**入力**：お客様のインプット資料、現行サイト。 **出力**：`01_requirements.md`（＋`inventory/*.md`）。
...
**入力**：`01_requirements.md`。 **出力**：`02_proposal-design.md`。
...
**入力**：`02_proposal-design.md`。 **出力**：`03_work-breakdown.md`。
...
**入力**：`02`＋`03`。 **出力**：`04_proposal.html` → `04_proposal.pdf`。
