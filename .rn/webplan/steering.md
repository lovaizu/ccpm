...
契約形態…）を一つずつ人と決め、決定が揃ったら提案書＋作業計画に畳む」こと。提案書と作業計画はその出力であって目的ではない。
...
利用者＝Web サイト制作の提案者（Provider）。場面＝案件の相談を受けてから提案書と作業計画を出すまで。基準は利用者が
...
1. **何を決めればよいか迷わない** — 決めるべき事項が最初から全部見えていて、順に決めていけば漏れなく揃う。
   - 確認：#1 とは別の案件で最後まで進め、途中で「決め忘れ」に気づいて戻ることが起きない。手順の外で人が補った
     決定が無い。
2. **決定が揃えば提案書と作業計画が出る** — 決めた内容以外を書く作業が無く、提案書・作業計画・決定の間に食い違いが無い。
...
工程とロール）で提案書と作業計画まで仕上げる。作業のたびに `project/worklog.md` へ〔決めたこと／順序／入力／成果物／
...
- [ ] 決定が揃ったら提案書と作業計画に畳む → ユーザーレビュー → 修正 → 納品形
...
- 提案者として、仮案件で「決めごとを決める → 提案書＋作業計画に畳む」を自分の手で最後まで経験し、提案書と作業計画が施主に
...
- `ccpm` から install した状態で提案者がスキルを起動し、設計どおりの順で決めごとを進めて提案書と作業計画に到達できる
  （1 案件で最後まで通る）。
