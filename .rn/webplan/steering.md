...
- **Last completed**: #1 Step 1・2（最終成果物＝計画、Requirement / Context / Planning ＋ Contract・ChangeLog の構造と決める順序、D-5）。
  Step 3 進行中：Goal（G-1〜G-3）は確定して `project/sample-project/plan.md` に記載済み。`learnings.md` に起案の観点 14 件を先行記録。
...
- **Notes**:
  ...
  - 計画の本体 `.rn/webplan/project/sample-project/plan.md` と `worklog.md` は gitignore（push しない）。学びは `learnings.md` に一般化して push。
