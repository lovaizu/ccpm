...
3. **Be idempotent.** Outside the gate-approval archive you change nothing on disk, and an archive copy that already exists under its version-carrying name is confirmed, not rewritten — so being re-sent after a missing return is always safe; do the work again without ceremony.
