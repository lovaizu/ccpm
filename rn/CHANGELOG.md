...
- After every verdict the session's plan is redrawn toward your goal and judged by a separate evaluator — a way that keeps falling short is changed, not patched round after round.
